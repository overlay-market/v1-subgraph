...
export const FACTORY_ADDRESSES: Array<string> = ['0xC35093f76fF3D31Af27A893CDcec585F1899eE54']
export const PERIPHERY_ADDRESSES: Array<string> = ['0x10575a9C8F36F9F42D7DB71Ef179eD9BEf8Df238']
export const FACTORY_ADDRESS = FACTORY_ADDRESSES[0]
export const PERIPHERY_ADDRESS = PERIPHERY_ADDRESSES[0]
