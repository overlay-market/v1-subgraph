...
export class NIP__eip712DomainResult {
  value0: Bytes;
  value1: string;
  value2: string;
  value3: BigInt;
...
export class NIP extends ethereum.SmartContract {
  static bind(address: Address): NIP {
    return new NIP("NIP", address);
  }
  ...
  eip712Domain(): NIP__eip712DomainResult {
    let result = super.call(
      "eip712Domain",
    ...
    return new NIP__eip712DomainResult(
      result[0].toBytes(),
      result[1].toString(),
      result[2].toString(),
      result[3].toBigInt(),
  ...
  try_eip712Domain(): ethereum.CallResult<NIP__eip712DomainResult> {
    let result = super.tryCall(
      "eip712Domain",
      "eip712Domain():(bytes1,string,string,uint256,address,bytes32,uint256[])",
      []
