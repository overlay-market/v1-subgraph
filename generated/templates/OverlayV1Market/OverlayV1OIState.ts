...
export class OverlayV1OIState__dataResultData_Struct extends ethereum.Tuple {
...
export class OverlayV1OIState__oisResult {
  value0: BigInt;
  value1: BigInt;
...
export class OverlayV1OIState__pricesResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class OverlayV1OIState__volumesResult {
  value0: BigInt;
  value1: BigInt;
...
export class OverlayV1OIState extends ethereum.SmartContract {
  static bind(address: Address): OverlayV1OIState {
    return new OverlayV1OIState("OverlayV1OIState", address);
  }
  ...
  data(feed: Address): OverlayV1OIState__dataResultData_Struct {
    let result = super.call(
      "data",
    ...
    return changetype<OverlayV1OIState__dataResultData_Struct>(
      result[0].toTuple()
    );
  }
  ...
  try_data(
    feed: Address
  ): ethereum.CallResult<OverlayV1OIState__dataResultData_Struct> {
    let result = super.tryCall(
      "data",
      "data(address):((uint256,uint256,uint256,uint256,uint256,uint256,uint256,bool))",
      [ethereum.Value.fromAddress(feed)]
    ...
    return ethereum.CallResult.fromValue(
      changetype<OverlayV1OIState__dataResultData_Struct>(value[0].toTuple())
    );
  }
  ...
  ois(feed: Address): OverlayV1OIState__oisResult {
    let result = super.call("ois", "ois(address):(uint256,uint256)", [
      ethereum.Value.fromAddress(feed)
    ]);

    return new OverlayV1OIState__oisResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }

  try_ois(feed: Address): ethereum.CallResult<OverlayV1OIState__oisResult> {
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new OverlayV1OIState__oisResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }

  prices(feed: Address): OverlayV1OIState__pricesResult {
    let result = super.call(
      "prices",
    ...
    return new OverlayV1OIState__pricesResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_prices(
    feed: Address
  ): ethereum.CallResult<OverlayV1OIState__pricesResult> {
    let result = super.tryCall(
      "prices",
      "prices(address):(uint256,uint256,uint256)",
      [ethereum.Value.fromAddress(feed)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new OverlayV1OIState__pricesResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
  ...
  volumes(feed: Address): OverlayV1OIState__volumesResult {
    let result = super.call("volumes", "volumes(address):(uint256,uint256)", [
      ethereum.Value.fromAddress(feed)
    ]);

    return new OverlayV1OIState__volumesResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_volumes(
    feed: Address
  ): ethereum.CallResult<OverlayV1OIState__volumesResult> {
    let result = super.tryCall(
      "volumes",
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new OverlayV1OIState__volumesResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
