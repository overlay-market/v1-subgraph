...
export class PlanckCat extends ethereum.SmartContract {
  static bind(address: Address): PlanckCat {
    return new PlanckCat("PlanckCat", address);
  }
...
export class SafeMintCustomCall extends ethereum.Call {
  get inputs(): SafeMintCustomCall__Inputs {
    return new SafeMintCustomCall__Inputs(this);
  }

  get outputs(): SafeMintCustomCall__Outputs {
    return new SafeMintCustomCall__Outputs(this);
  }
}

export class SafeMintCustomCall__Inputs {
  _call: SafeMintCustomCall;

  constructor(call: SafeMintCustomCall) {
    this._call = call;
  }
  ...
  get _customURI(): string {
    return this._call.inputValues[1].value.toString();
  }
}

export class SafeMintCustomCall__Outputs {
  _call: SafeMintCustomCall;
