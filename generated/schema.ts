...
export class Transaction extends Entity {
  ...
  get builds(): BuildLoader {
    return new BuildLoader("Transaction", this.get("id")!.toString(), "builds");
  }
...
export class ChainlinkFeed extends Entity {
  constructor(id: string) {
    super();
    this.set("id", Value.fromString(id));
  }
  ...
  save(): void {
    let id = this.get("id");
    assert(id != null, "Cannot save ChainlinkFeed entity without an ID");
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
        `Entities of type ChainlinkFeed must have an ID of type String but the id '${id.displayData()}' is of type ${id.displayKind()}`,
      );
      store.set("ChainlinkFeed", id.toString(), this);
    }
  }

  static loadInBlock(id: string): ChainlinkFeed | null {
    return changetype<ChainlinkFeed | null>(
      store.get_in_block("ChainlinkFeed", id),
    );
  }

  static load(id: string): ChainlinkFeed | null {
    return changetype<ChainlinkFeed | null>(store.get("ChainlinkFeed", id));
  }
  ...
  set heartbeat(value: BigInt) {
    this.set("heartbeat", Value.fromBigInt(value));
  }
}
